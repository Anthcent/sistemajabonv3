...
<div x-data="inventory('all')" class="w-full px-4 md:px-8 pb-20 pt-8" x-cloak>
    ...
    <div class="glass p-8 rounded-2xl border border-gray-200 dark:border-white/5 shadow-xl relative overflow-hidden mb-12">
            ...
            <div class="flex items-center gap-4">
                <div class="relative flex-grow">
                    ...
                    <input 
                        ...
                        class="w-full bg-white dark:bg-dark-bg/50 border border-gray-300 dark:border-gray-700 rounded-xl py-2.5 pl-10 pr-4 text-gray-900 dark:text-white focus:border-brand-500 focus:outline-none placeholder-gray-400 dark:placeholder-gray-600 transition-all font-bold"
                    >
                    <!-- Dropdown Results -->
                        ...
                        <template x-for="item in cloneResults" :key="item.id">
                            <button @click="fillForm(item)" class="w-full text-left px-4 py-3 hover:bg-brand-600/10 dark:hover:bg-brand-600/20 flex justify-between items-center group transition-colors border-b border-gray-100 dark:border-white/5 last:border-0">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <span class="font-bold text-gray-800 dark:text-white block text-sm" x-text="item.name"></span>
        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-8">
            ...
            <div class="md:col-span-3 flex flex-col">
                ...
                <!-- ID must match app.js handler -->
                <!-- ID must match app.js handler -->
                <input id="fileInput" type="file" @change="handleImage" class="hidden" accept="image/*">
                <!-- Native Camera Input -->
                <input id="cameraInput" type="file" @change="handleImage" class="hidden" accept="image/*" capture="environment">
                
                <button @click="document.getElementById('cameraInput').click()" class="mt-2 w-full py-2 rounded-lg bg-gray-100 dark:bg-white/5 hover:bg-gray-200 dark:hover:bg-white/10 text-gray-600 dark:text-gray-300 text-xs font-bold transition-colors flex items-center justify-center gap-2">
                    <i class="fa-solid fa-camera"></i> Cargar Imagen
                </button>
            </div>
            ...
            <div class="md:col-span-9 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative" @click.outside="showCatDropdown = false">
                            <div @click="showCatDropdown = !showCatDropdown" class="w-full bg-white dark:bg-dark-bg/50 border border-gray-300 dark:border-gray-700 rounded-xl py-3 pl-10 pr-4 text-gray-900 dark:text-white focus-within:border-brand-500 focus-within:ring-1 focus-within:ring-brand-500 cursor-pointer flex items-center justify-between h-[54px]">
                                ...
                                <div class="flex items-center gap-2 overflow-hidden">
                                    ...
                                    <span x-show="!selectedCatName" class="text-gray-400">Seleccionar...</span>
                                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input x-model="product.barcode" type="text" class="w-full bg-white dark:bg-dark-bg/50 border border-gray-300 dark:border-gray-700 rounded-xl py-2.5 pl-9 pr-3 text-gray-900 dark:text-white focus:border-brand-500 focus:outline-none font-mono text-sm" placeholder="Escaneo...">
                        </div>
                    </div>
                    <!-- SKU -->
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input x-model="product.sku" type="text" class="w-full bg-white dark:bg-dark-bg/50 border border-gray-300 dark:border-gray-700 rounded-xl py-2.5 pl-9 pr-3 text-gray-900 dark:text-white focus:border-brand-500 focus:outline-none font-mono text-sm" placeholder="CODE">
                        </div>
                    </div>
                    <!-- Brand -->
                    <div>
                         <label class="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-2">Marca</label>
                        <input x-model="product.brand" type="text" class="w-full bg-white dark:bg-dark-bg/50 border border-gray-300 dark:border-gray-700 rounded-xl py-2.5 px-3 text-gray-900 dark:text-white focus:border-brand-500 focus:outline-none text-sm" placeholder="Marca">
                    </div>
                </div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex flex-col">
                                <span class="text-xs font-bold uppercase transition-colors duration-300" 
                                      :class="product.is_raw_material ? 'text-orange-500' : 'text-gray-500 dark:text-gray-400'">¿Es Materia Prima?</span>
                ...
                <!-- Row 4: Prices & Units -->
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6 bg-gray-50 dark:bg-gray-800/30 p-4 rounded-xl border border-gray-200 dark:border-white/5">
                     <div>
                    ...
                    <div>
                        <label class="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-2">Min. Alerta</label>
                        <input x-model="product.min_stock" type="number" step="0.01" class="w-full bg-white dark:bg-dark-bg border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 text-gray-900 dark:text-white focus:border-brand-500 focus:outline-none" placeholder="10">
                    </div>
                    <div>
                ...
                <div x-show="formMode === 'create'" 
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="flex items-end gap-4">
                            ...
                            <!-- Unit Label -->
                            <div class="pb-2 font-bold text-sm opacity-70 text-gray-800 dark:text-white" x-text="product.display_unit"></div>
                        </div>
    ...
    <!-- Camera Modal -->
    <!-- Camera Modal Removed (Using Native Camera) -->
